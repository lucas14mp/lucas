...
public class Ficha01DAO {
    ...
    public static void create(Ficha01 ficha) {
        String sql = "INSERT INTO ficha01(id_moeda, id_pais, valor_database, dividendos, data_criacao, trimestre, chave, id_status) VALUES (?,?,?,?,?,?,?,?)";
    ...
    public static void update(Ficha01 ficha) {
        String sql = "UPDATE ficha01 SET id_moeda = ?, id_pais = ?, valor_database = ?, dividendos = ?, chave = ?, data_criacao = ? WHERE id = ?";
        Connection connection = null;
        PreparedStatement pst = null;
        try {
            connection = Conexao.conectar();
