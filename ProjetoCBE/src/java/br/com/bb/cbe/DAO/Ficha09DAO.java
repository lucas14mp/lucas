...
public class Ficha09DAO {

    Conexao conexao = new Conexao();

    public static void create(Ficha09 ficha) {
        String sql = "INSERT INTO ficha09(metodo_valoracao, valor_database, data_criacao, trimestre, id_moeda, id_pais, chave, id_status) VALUES (?,?,?,?,?,?,?,?)";
        ...
        try {
            ...
            pst.setInt(4, DataUtils.validaTrimestre()); // Cuidado: pode estar hardcoded aqui, o ideal seria ficha.getTrimestre()
    ...
    public static void update(Ficha09 ficha) {
        String sql = "UPDATE ficha09 SET metodo_valoracao = ?, valor_database = ?, id_moeda = ?, id_pais = ?, chave = ?, data_criacao = ? WHERE id = ?";
        Connection connection = null;
        PreparedStatement pst = null;
        try {
            connection = Conexao.conectar();
    ...
    public static void delete(int id) {
        String sql = "DELETE FROM ficha09 WHERE id = ?";
        Connection connection = null;
        PreparedStatement pst = null;
        try {
            connection = Conexao.conectar();
    ...
    public static List<Ficha09> getAllFichas() {
        String query = "SELECT * FROM ficha09";
        List<Ficha09> listaFichas = new ArrayList<Ficha09>();
        Connection connection = null;
        Ficha09 ficha = null;
        ResultSet rs = null;
        PreparedStatement pst = null;
    ...
    public static List<Ficha09> getAllFichasByTrimestreAno(int trimestre, int ano) {
        switch (trimestre) {
        ...
        String query = "SELECT * FROM ficha09 WHERE trimestre = " + trimestre + " AND YEAR(data_criacao) = " + ano;
        List<Ficha09> listaFichas = new ArrayList<Ficha09>();
        Connection connection = null;
        Ficha09 ficha = null;
        ResultSet rs = null;
    ...
    public static Optional<Ficha09> getFichaById(int id) {
        String query = "SELECT * FROM ficha09 WHERE id = " + id;
        Connection connection = null;
        Ficha09 ficha = null;
        ResultSet rs = null;
        PreparedStatement pst = null;
    ...
    public static void validarFormularios(List<String> idsValidados, String chave) {
        ...
        StringBuilder sql = new StringBuilder("UPDATE ficha09 SET id_status = 2, chave = '" + chave + "' WHERE id IN (");
    ...
    public static List<Integer> getAnosExistentes() {
        ...
        String sql = "SELECT DISTINCT YEAR(data_criacao) as ano FROM ficha09 ORDER BY ano DESC";
        Connection connection = null;
        PreparedStatement pst = null;
        ResultSet rs = null;
        try {
    ...
    public static List<Integer> getTrimestresExistentes() {
        ...
        String sql = "SELECT DISTINCT trimestre FROM ficha09 ORDER BY trimestre ASC";
        Connection connection = null;
        PreparedStatement pst = null;
        ResultSet rs = null;
        try {
    ...
    public static List<Ficha09> getAllFichasByAno(int ano) {
        String query = "SELECT * FROM ficha09 WHERE YEAR(data_criacao) = " + ano;
        List<Ficha09> listaFichas = new ArrayList<>();
        Connection connection = null;
        Ficha09 ficha = null;
        ResultSet rs = null;
        PreparedStatement pst = null;
    ...
    public static List<Ficha09> getAllFichasByTrimestre(int trimestre) {
        switch (trimestre) {
            case 1: trimestre = 2; break;
            case 2: trimestre = 3; break;
            case 3: trimestre = 4; break;
        ...
        String query = "SELECT * FROM ficha09 WHERE trimestre = " + trimestre;
        List<Ficha09> listaFichas = new ArrayList<>();
        Connection connection = null;
        Ficha09 ficha = null;
        ResultSet rs = null;
