    ...
    <body>
        ...
        <main class="main">
            <article class="article">
                ...
                <p>
                    Devem ser declarados nesta ficha quando (i) o declarante ou o devedor for pessoa física, em todos os casos e (ii) quando o devedor for pessoa jurídica que não pertença ao mesmo grupo econômico do declarante pessoa jurídica.          
                </p>
                <p>
                    Caso a empresa devedora de empréstimos no exterior seja do mesmo grupo econômico da empresa declarante, esses ativos devem ser declarados na ficha “Empréstimos intercompanhia” .
                </p>
                <p>
                ...
                <p>
                    Podem ser agregadas informações de diversos empréstimos, desde que sejam coincidentes o país do devedor, a moeda de denominação e a categoria do prazo original do empréstimo.
                </p>
                <br>
