    ...
    <body>
        ...
        <main class="p-4 w-100 d-flex flex-column justify-content-center align-items-center my-1" style="height: 50%">
            <div>
                ...
                <h1 class="fs-3 text-preto text-center fw-bold"> Tabela de inserção e visualização PTAX </h1>
                <h2 class="fs-5 text-center text-cinza fw-normal"> Selecione a opção desejada para seguir em PTAX </h2>
            </div>
            ...
            <div class="mt-4 w-100">
                ...
                <div class="container d-flex justify-content-center column-gap-4">
                    <a href="forms/Ptax.jsp" class="d-block text-decoration-none">
                        <div style="width: 20vw; height: 30vh" class=" bg-white rounded shadow-sm p-4 d-flex flex-column justify-content-center align-items-center mb-1 option-card">
                            ...
                            <div class="d-flex flex-column row-gap-2">
                                <h4 class="fw-bold text-azul-banco text-center" style="font-size: 20px; margin: 1px">Inserir dados PTAX</h4>
                                <p class="text-center text-cinza" style="font-size: 14px; margin: 0px">Tabela para inserção de valores PTAX</p>
                                <h5 class="text-azul-banco text-center" style="font-size: 14px; margin: 0px">Ver mais <i class="bi bi-arrow-right"></i></h5>
                            </div>
                        </div>
                    </a>
                    <a href="views/taxas.jsp" class="d-block text-decoration-none">
                        <div style="width: 20vw; height: 30vh" class="bg-white rounded shadow-sm p-4 d-flex flex-column justify-content-center align-items-center mb-1 option-card">
                            <img src="resources/imgs/visualizarPTAX.png" alt="Propostas Orçamentárias" class="icone-card"/>


                            <div class="d-flex flex-column row-gap-2">
                                <h4 class="fw-bold text-azul-banco text-center" style="font-size: 20px; margin: 1px">Visualizar PTAX</h4>
                                <p class="text-center text-cinza" style="font-size: 14px; margin: 0px">Relatório de valores PTAX</p>
                                <h5 class="text-azul-banco text-center" style="font-size: 14px; margin: 0px">Ver mais <i class="bi bi-arrow-right"></i></h5>
                            </div>
                        </div>
                    </a>
