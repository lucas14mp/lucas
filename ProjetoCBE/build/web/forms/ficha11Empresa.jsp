        ...
        <main class="main">
            <article class="article">
                ...
                <div class='dados-empresa-preenchida'>
                    ...
                    <p><b>Esta empresa possui cotação em bolsa de valores no exterior?</b> ${ficha.isPossuiCotacaoEmBolsa() ? "Sim" : "Não"}</p>
                    <p><b>Moeda do país da empresa no exterior:</b> ${ficha.getMoeda().getSigla()} - ${ficha.getMoeda().getNome()}</p>
                    <p><b>Método de valoração:</b> ${ficha.getMetodoValoracao()}</p>
                    <p><b>Valor da empresa na data-base:</b> ${ficha.getValorEmpresa() != -0.01 ? ficha.getMoeda().getSimbolo() : ""} ${ficha.getValorEmpresa() != -0.01 ? numeroUtils.doubleToString(ficha.getValorEmpresa()) : "Não informado"}</p>
                    <p><b>Patrimônio líquido total na data-base:</b> ${ficha.getPatrimonioTotal() != -0.01 ? ficha.getMoeda().getSimbolo() : ""} ${ficha.getPatrimonioTotal() != -0.01 ? numeroUtils.doubleToString(ficha.getPatrimonioTotal()) : "Não informado"}</p>
                    <p><b>Percentual de participação no capital social:</b> ${ficha.getPorcentoParticipacaoCapital() != -0.01 ? numeroUtils.doubleToString(ficha.getPorcentoParticipacaoCapital()) : "Não informado"}${ficha.getPorcentoParticipacaoCapital() != -0.01 ? "%" : ""}</p>
                    <p><b>Percentual de poder de voto:</b> ${ficha.getPorcentoPoderVoto() != -0.01 ? numeroUtils.doubleToString(ficha.getPorcentoPoderVoto()) : "Não informado"}${ficha.getPorcentoPoderVoto() != -0.01 ? "%" : ""}</p>
                    <p><b>Ativo na data-base:</b> ${ficha.getAtivoDatabase() != -0.01 ? ficha.getMoeda().getSimbolo() : ""} ${ficha.getAtivoDatabase() != -0.01 ? numeroUtils.doubleToString(ficha.getAtivoDatabase()) : "Não informado"}</p>
                    <p><b>Passivo exigível na data-base:</b> ${ficha.getPassivoExigivel() != -0.01 ? ficha.getMoeda().getSimbolo() : ""} ${ficha.getPassivoExigivel() != -0.01 ? numeroUtils.doubleToString(ficha.getPassivoExigivel()) : "Não informado"}</p>
                    <p><b>Valor total do lucro ou prejuízo líquidos da empresa no exterior:</b> ${ficha.getValorTotalLucroPrejuizo() != -0.01 ? ficha.getMoeda().getSimbolo() : ""} ${ficha.getValorTotalLucroPrejuizo() != -0.01 ? numeroUtils.doubleToString(ficha.getValorTotalLucroPrejuizo()) : "Não informado"}</p>
                    <p><b>Resultado líquido de itens não recorrentes:</b> ${ficha.getResultadoLiquidoItensNaoRecorrentes() != -0.01 ? ficha.getMoeda().getSimbolo() : ""} ${ficha.getResultadoLiquidoItensNaoRecorrentes() != -0.01 ? numeroUtils.doubleToString(ficha.getResultadoLiquidoItensNaoRecorrentes()) : "Não informado"}</p>
                    <p><b>Resultado líquido de reavaliações (ex. impairment):</b> ${ficha.getResultadoLiquidoReavaliacoes() != -0.01 ? ficha.getMoeda().getSimbolo() : ""} ${ficha.getResultadoLiquidoReavaliacoes() != -0.01 ? numeroUtils.doubleToString(ficha.getResultadoLiquidoReavaliacoes()) : "Não informado"}</p>
                    <p><b>Resultado líquido de variação cambial:</b> ${ficha.getResultadoLiquidoVariacaoCambial() != -0.01 ? ficha.getMoeda().getSimbolo() : ""} ${ficha.getResultadoLiquidoVariacaoCambial() != -0.01 ? numeroUtils.doubleToString(ficha.getResultadoLiquidoVariacaoCambial()) : "Não informado"}</p>
                    <p><b>Lucro distribuído no período-base:</b> ${ficha.getLucroDistribuido() != -0.01 ? ficha.getMoeda().getSimbolo() : ""} ${ficha.getLucroDistribuido() != -0.01 ? numeroUtils.doubleToString(ficha.getLucroDistribuido()) : "Não informado"}</p>
