    ...
    <body>
        ...
        <main class="main">
            <article class="article">
                ...
                <br>
                <p>
                    Devem ser declarados nesta ficha títulos de dívida emitidos por empresas no exterior pertencentes ao mesmo grupo econômico da empresa declarante.
                </p>
                <p>
                    Títulos de dívida são instrumentos negociáveis no mercado financeiro, representativos de dívida entre o emissor (não residente) e seu detentor
                    (residente, declarante do CBE). Incluem todos os títulos de dívida negociáveis no mercado tais como títulos de renda fixa, bônus, bonds, notes,
                    commercial papers, certificados de depósito bancário, entre outros instrumentos similares.
                </p>
                <p>
                    Caso a empresa emissora dos títulos no exterior não seja do mesmo grupo econômico da empresa declarante, esses ativos devem ser declarados 
                    na ficha “Título de dívida não-intercompanhia”.
                </p>
                <p>
                    Podem ser agregadas informações de diversos títulos, desde que sejam coincidentes a empresa do grupo econômico emissora do título, a moeda de 
                    denominação e a categoria do prazo original do título de dívida intercompanhia.
                </p>
                <br>
                ...
                <form action="<%=request.getContextPath()%>/ficha17" method="post" class="form">
                    ...
                    <select name="empresa" id="empresa" required>
                        <option value="" selected>Selecione a empresa emissora</option>
