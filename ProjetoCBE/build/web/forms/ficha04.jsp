    ...
    <body>
        ...
        <main class="main">
            <article class="article">
                ...
                <h2>Ficha 4 - Crédito comercial intercompanhia</h2>
                <p>
                    Para preenchimento apenas para declarantes pessoas jurídicas. Devem ser declarados nesta ficha os ativos de créditos comerciais da empresa declarante junto a empresas do mesmo grupo econômico no exterior. Caso a empresa devedora de créditos comerciais no exterior não seja do mesmo grupo econômico da empresa declarante, esses ativos devem ser declarados na ficha “Crédito comercial não-intercompanhia”.
                </p>
                <p>
                    Ainda que o financiamento esteja associado ao comércio de bens e serviços, se houver intermediação de instituição financeira, não se trata de crédito comercial. Nesta hipótese, avaliar a inclusão do ativo na modalidade de empréstimo, quando a contraparte devedora (instituição financeira que intermediou a transação) seja não residente.
                </p>
                <p>
                    Créditos comerciais compreendem financiamentos concedidos diretamente entre exportador e importador para aquisição de bens ou serviços em transações de comércio exterior. Os ativos, na modalidade crédito comercial, podem constituir-se de duas formas:<br>
                    ...
                    saída de recursos financeiros do País e é um ativo externo recebível em bens ou serviços;<br>
                ...
                <p>
                    Podem ser agregadas informações de diversos créditos comerciais intercompanhia, desde que sejam coincidentes a empresa devedora do crédito comercial, a moeda de denominação e a categoria do prazo original do crédito comercial.
                </p>
                <form action="" method="post" class="form">

                    <div class="label-container">
                        <picture class="informacao-container" title="Escolher entre as empresas no exterior previamente cadastradas, o devedor do crédito comercial no exterior.">
                            <img src="../resources/imgs/informacao.png" alt="Ícone informação"/>
                        </picture>
                        <label for="nomeEmpresa">Informar nome da empresa:</label>
                    </div>
                    <input type="text" name="nomeEmpresa" required id="nomeEmpresa" placeholder="Insira o nome da empresa">
                    ...
                    <div class="label-container">
                        <picture class="informacao-container" title="O prazo original em meses refere-se ao prazo contratual previsto para liquidação da operação. Não se refere ao prazo residual entre a data-base da declaração e a data prevista para liquidação. Para avaliação do prazo devem ser usados parâmetros contratuais, independentemente da data do recebimento efetivo da mercadoria, que pode ser diferente do contratual. Para determinar a data de recebimento da mercadoria, o
                                 declarante deve considerar, para cada contrato, o momento em que ocorre a mudança de propriedade. Selecionar uma opção para o prazo total da operação: “Até 12 meses” ou “Mais de 12 meses”. Na hipótese de prazo flexível ou indefinido, utilize a melhor expectativa.">
                            <img src="../resources/imgs/informacao.png" alt="Ícone informação"/>
                        </picture>
                    ...
                    <select name="prazoOriginal" id="prazoOriginal" required>
                        ...
                        <option value="Até 12 meses">Até 12 meses</option>
